...
use constant DEVICE_DISPLAY_NAME => 'RED Brick';
...
use constant ERROR_CODE_SUCCESS => 0;
use constant ERROR_CODE_UNKNOWN_ERROR => 1;
use constant ERROR_CODE_INVALID_OPERATION => 2;
use constant ERROR_CODE_OPERATION_ABORTED => 3;
use constant ERROR_CODE_INTERNAL_ERROR => 4;
use constant ERROR_CODE_UNKNOWN_SESSION_ID => 5;
use constant ERROR_CODE_NO_FREE_SESSION_ID => 6;
use constant ERROR_CODE_UNKNOWN_OBJECT_ID => 7;
use constant ERROR_CODE_NO_FREE_OBJECT_ID => 8;
use constant ERROR_CODE_OBJECT_IS_LOCKED => 9;
use constant ERROR_CODE_NO_MORE_DATA => 10;
use constant ERROR_CODE_WRONG_LIST_ITEM_TYPE => 11;
use constant ERROR_CODE_PROGRAM_IS_PURGED => 12;
use constant ERROR_CODE_INVALID_PARAMETER => 128;
use constant ERROR_CODE_NO_FREE_MEMORY => 129;
use constant ERROR_CODE_NO_FREE_SPACE => 130;
use constant ERROR_CODE_ACCESS_DENIED => 121;
use constant ERROR_CODE_ALREADY_EXISTS => 132;
use constant ERROR_CODE_DOES_NOT_EXIST => 133;
use constant ERROR_CODE_INTERRUPTED => 134;
use constant ERROR_CODE_IS_DIRECTORY => 135;
use constant ERROR_CODE_NOT_A_DIRECTORY => 136;
use constant ERROR_CODE_WOULD_BLOCK => 137;
use constant ERROR_CODE_OVERFLOW => 138;
use constant ERROR_CODE_BAD_FILE_DESCRIPTOR => 139;
use constant ERROR_CODE_OUT_OF_RANGE => 140;
use constant ERROR_CODE_NAME_TOO_LONG => 141;
use constant ERROR_CODE_INVALID_SEEK => 142;
use constant ERROR_CODE_NOT_SUPPORTED => 143;
use constant ERROR_CODE_TOO_MANY_OPEN_FILES => 144;
